<template>
  <span style="text-align: left; margin-left: 10px;">
    <el-button
      class="search-button btn-icon-class"
      size="small"
    ...
    <el-dialog :modal-append-to-body="true"
      ...
      <div>
        <el-table v-loading="dir.loadingDir"
          ...
          <el-table-column :selectable="selectInit"
                           style=""
                           type="selection"
